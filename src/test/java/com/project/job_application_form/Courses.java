...
public class Courses {
    ...
    private String сoursesStartYear;
    private String сoursesDuration;
    private String сoursesName;
    private String сoursesSpecialization;
    private String сoursesCertificates;

    // Форматирование вывода данных
    public String getCourses () {
        String StartYear = сoursesStartYear != null ? сoursesStartYear : "";

        return String.format("%s, %s, %s, %s, %s, %s",
                StartYear, сoursesDuration, сoursesName, сoursesSpecialization, сoursesCertificates);
    }
